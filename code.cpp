...
int main() {
    //! Creating Persons..
    Person* pat1= new Patient("Hamza Shahab");
    Person* pat2= new Patient("Muhammad Ibrahim");
    Person* pat3= new Patient("Abdullah Hayat");
    Person* doc1= new Doctor("Dr. Khurram Meraj");
    Person* doc2= new Doctor("Dr. A");
    Person* doc3= new Doctor("Dr. B");
